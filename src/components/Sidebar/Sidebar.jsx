...
const Sidebar = () => {
    return (
        <aside>
            ...
            <NavLink to='/united%20kingdom' activeClassName="selected"><Button icon={uk} country='United Kingdom' /></NavLink>
            ...
            <NavLink to='/russian%20federation' activeClassName="selected"><Button icon={russia} country='Russia' /></NavLink>
        </aside>
    )
}
